...
const TRANSITION_MAP: Record<AgentState, AgentState[]> = {
    ...
    [AgentState.ANALYZING_PAGE]: [AgentState.EXECUTING_TASK, AgentState.NAVIGATING, AgentState.BLOCKED, AgentState.RECOVERY_MODE, AgentState.FAILED],
    [AgentState.AUTHENTICATING]: [AgentState.NAVIGATING, AgentState.BLOCKED, AgentState.RECOVERY_MODE, AgentState.FAILED],
    ...
    [AgentState.BLOCKED]: [AgentState.RECOVERY_MODE, AgentState.FAILED],
